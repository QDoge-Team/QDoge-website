 ...
 * between our first pull and this one, and QRAFFLE turned out to have paid in
 * 222-224 after being recorded as inactive. Treat any pull as a snapshot, not
 * a permanent fact, and re-verify per-asset (not just the homepage) on refresh.
 * QTREAT's own epoch 222-225 figures supplied directly by the team.
...
export const DIVIDEND_PROJECTS: DividendProject[] = [
  {
    ...
    kind: 'token',
    scIndex: null,
    weeklyYieldPct: 0.6152,
    annualYieldPct: 31.99,
    paybackWeeks: 162.6,
    avgWeekly: 123034.32,
  ...
  },
  {
    ...
    kind: 'contract',
    scIndex: 13,
    weeklyYieldPct: 0.0086,
    annualYieldPct: 0.45,
    paybackWeeks: 11665.7,
    avgWeekly: 128581.83,
  ...
  },
  {
    ...
    kind: 'contract',
    scIndex: 12,
    weeklyYieldPct: 0.005,
    annualYieldPct: 0.26,
    paybackWeeks: 20068.2,
    avgWeekly: 21925.26,
